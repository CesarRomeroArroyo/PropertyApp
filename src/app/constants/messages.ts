export const messages = {
    ...
    REGISTER_INPUST_ERROR: {
        NAME_REQUERID: "Por favor, digite su nombre.",
        NAME_MINLENGHT: "El nombre debe tener al menos 3 caracteres.",
        EMAIL_REQUERID: "Por favor, digite su correo.",
        EMAI_LINVALID: "Dirección de correo invalido.",
        CC_QUERID: "Por favor, digite su cedula.",
        CC_MINLENGHT: "La cedula debe tener al menos 6 caracteres.",
        NUMBRE: "Solo valores numericos",
        USER_REQUERID: "Por favor, digite su usuario.",
        USER_MINLENGHT: "El usuario debe tener al menos 3 caracteres.",
        PASS_REQUERID: "Por favor, digite su contraseña",
        PASS_MINLENGHT: "la contraseña debe tener al menos 8 caracteres.",
